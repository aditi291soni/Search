...
export class AddAddressComponent implements AfterViewInit {
   ...
   constructor(
      ...
      this.businessDetail = this.apiService.getLocalValueInJSON(
   ...
   currentLocation() {
      ...
      const allowedBounds = {
         latMin: 23.15, // Minimum latitude
         latMax: 23.35, // Maximum latitude
         lngMin: 77.35, // Minimum longitude
         lngMax: 77.55, // Maximum longitude
      };
   ...
   getStateId() {
      ...
      const matchedState = this.listofState.find(
         (state: any) =>
