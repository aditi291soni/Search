...
export class ApiService {
   ...
   getListOfBusinesses(): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/list-of-business`, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of businesses:', error); // Log error for debugging
               return throwError(
                  () => new Error('Failed to fetch the list of businesses')
   ...
   list_of_banner(payload: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-super-banner-list`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   create_wallet_amount(payload: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/create-wallet`, payload, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of businesses:', error); // Log error for debugging
               return throwError(
   ...
   get_wallet_amount(payload: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-total-wallet-balance`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   add_wallet_amount(payload: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/add-wallet-balance`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   deduct_wallet_amount(payload: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/deduct-wallet-balance`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   delete_address(payload: any): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/deleteAddress`, payload, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of businesses:', error); // Log error for debugging
               return throwError(
   ...
   redeem_coupan(payload: any): Observable<any> {
      ...
      return this.http
         .post(
            `${devURL}/coupon/redeem/verify-redeem-coupon`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
            catchError((error) => {
               console.error(
                  'Error fetching the redeem coupan:',
                  error.error.error
   ...
   add_redeem(payload: any): Observable<any> {
      ...
      return this.http
         .post(
            `${devURL}/coupon/redeem/add-redeem-coupon`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
      ...
      return this.http
         ...
         .pipe(
            catchError((error) => {
               ...
               return throwError(
                  () => new Error('Failed to fetch the list of addresses')
               ); // Return a user-friendly error message
            })
         );
   }
   add_address(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/addAddress`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   get_address(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/getAddress`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   edit_address(params: object): Observable<any> {
      ...
      return this.http
         .post(`${this.baseUrl}/editAddress`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   add_user(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/addUser`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   add_role_allot(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/add-role-allot`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   get_user(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/getUser`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   search_user(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/search-users`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   edit_user(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/editUser`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   getOrderDeliveryDetail(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-order-delivery-details`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   getDelivery(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-delivery-type`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   getTimeSlots(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/get-time-slot`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   getOrderStatus(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-master-order-status-list`,
            this.getHttpOptions()
         )
         .pipe(
            catchError((error) => {
   ...
   getOrderDelivery(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-order-delivery-details-list`,
            params,
            this.getHttpOptions()
         )
         .pipe(
            catchError((error) => {
               console.error(
                  'Error fetching in delivery detail:',
                  error.error.msg
               ); // Log error for debugging
   ...
   getInvoice(params: object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/get-invoice`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   getAddressList(payload: any): Observable<any> {
      ...
      return this.http
         .post(`${this.baseUrl}/getAddressList`, payload, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of addresses:', error); // Log error for debugging
               return throwError(
   ...
   getTimeSlot(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-time-slot-list`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   getDeliveryType(params: object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-delivery-type-list`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   getVehicleTypeList(superAdminId: string | number): Observable<any> {
      ...
      return this.http
         .post(
            `${this.baseUrl}/get-vehicle-type-list`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
            catchError((error) => {
               console.error(
                  'Error fetching the list of vehicle types:',
                  error
               ); // Log error for debugging
               return throwError(
                  () => new Error('Failed to fetch the list of vehicle types')
               ); // Return a user-friendly error message
            })
         );
   }
      ...
      return this.http
         ...
         .pipe(
            catchError((error) => {
               ...
               return throwError(
                  () => new Error('Failed to fetch the list of business')
               ); // Return a user-friendly error message
            })
         );
   }
   getOrderList(payload: Object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/get-order-invoice-list`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   createDelivery(payload: Object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/add-order-delivery-details`,
            payload,
            this.getHttpOptions()
         )
         .pipe(
   ...
   getStateList(countryId: string): Observable<any> {
      ...
      return this.http
         .get(`${this.baseUrl}/states?country_id=101`, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   get_financial_year_list(): Observable<any> {
      return this.http
         .get(`${this.baseUrl}/get-financial-year-list`, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   getLedger(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/get-ledger-list`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   addBusiness(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/add-business`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   editBusiness(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/edit-business`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   getBusiness(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/get-business`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   addInvoice(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/add-invoice`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   editInvoice(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/edit-invoice`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   addTransaction(params: Object): Observable<any> {
      return this.http
         .post(`${this.baseUrl}/add-transaction`, params, this.getHttpOptions())
         .pipe(
            catchError((error) => {
               console.error('Error fetching the list of business:', error); // Log error for debugging
               return throwError(
   ...
   addNotification(params: Object): Observable<any> {
      ...
      return this.http
         .post(
            `${this.baseUrl}/active-rider-location-for-order`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   edit_order_delivery_details(params: Object): Observable<any> {
      return this.http
         .post(
            `${this.baseUrl}/edit-order-delivery-details`,
            params,
            this.getHttpOptions()
         )
         .pipe(
   ...
   private getHttpOptionMaster(): { headers: HttpHeaders } {
      const token =
         'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..p2N6hijIinP5UG8wjXFloCnTOfO24kYMp-4_Ca3wY9k'; // Replace with a secure method if needed
      return {
         headers: new HttpHeaders({
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token || ''}`,
   ...
   getLocalValueInJSON2(value: string | null) {
      try {
